...
class PersonServiceTest {
    ...
    void put() {
        ...
        verify(personRepository, times(1)).save(argThat(new IsPersonWillBePut()));
    }
    ...
    private static class IsPersonWillBePut implements ArgumentMatcher<Person> {
